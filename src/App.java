...
public class prac {
    ...
    public static void main(String[] args) throws Exception {
        ...
        while (true) {
        	in.println("=== Guess the number! ===");
            in.println("1. Easy (1-10) ");
            in.println("2. Intermediate (1-100) ");
            in.println("3. God Mode (1-100000000) ");
            in.println("4. Exit ");
            in.print("Choose difficulty: ");
            int choice = in.ni();
            ...
            while (answer != secret) {
                in.print("What is the number? ");
                answer = in.ni();
                tries += 1;

                if (Math.random() >= 0.7) {
                    in.println("Woops, brain fart.... Can't help you here");
                } else {
                    if (answer < secret) {
                        in.println("Too low!");
                    } else {
            ...
            String leaderboardName = in.next();
